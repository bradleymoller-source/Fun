...
export const CLASS_FEATURES: Record<CharacterClass, ClassFeature[]> = {
  ...
  monk: [
    ...
    { name: 'Flurry of Blows', description: 'Bonus action: Spend 1 Focus Point to make 2 unarmed strikes.', level: 2 },
    { name: 'Patient Defense', description: 'Bonus action: Spend 1 Focus Point to take the Dodge action.', level: 2 },
    { name: 'Step of the Wind', description: 'Bonus action: Spend 1 Focus Point to take the Disengage or Dash action, and your jump distance is doubled for the turn.', level: 2 },
...
export const SPELL_DETAILS: Record<string, SpellDetails> = {
  ...
  'Mirror Image': {
    ...
    components: 'V, S',
    duration: '1 minute',
    description: 'Three illusory duplicates of yourself appear in your space. Each time a creature targets you with an attack, roll a d20 to determine whether the attack instead targets one of your duplicates.',
  },
  'Silence': {
    name: 'Silence',
    level: 2,
  ...
  'Calm Emotions': {
    ...
    duration: '1 minute',
    concentration: true,
    description: 'You attempt to suppress strong emotions in a group of people. Each humanoid in a 20-foot-radius sphere centered on a point you choose within range must make a Charisma saving throw; a creature can choose to fail this saving throw if it wishes.',
  ...
  // ===== ILLUSION SPELLS (for Shadow Touched) =====
  'Silent Image': {
    name: 'Silent Image',
    level: 1,
    school: 'illusion',
  ...
  // ===== NECROMANCY SPELLS (for Shadow Touched) =====
  'False Life': {
    name: 'False Life',
    level: 1,
    school: 'necromancy',
  ...
  'Cause Fear': {
    ...
    duration: '1 minute',
    concentration: true,
    description: 'You awaken the sense of mortality in one creature you can see within range. A construct or an undead is immune to this effect. The target must succeed on a Wisdom saving throw or become frightened of you until the spell ends.',
    savingThrow: 'wisdom',
  },
};
